...
Tests, benchmarks, and fuzzers require an out-of-source build directory.
...
Library-only configuration, installation, and source packaging also support
in-source builds with tests, benchmarks, and fuzzers disabled. Start from a clean
checkout or extracted source tree: disabling verification does not remove files
generated by an earlier in-source verification build.
